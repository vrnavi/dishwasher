...
class Diff(Cog):
    ...
    async def diff(self, ctx: commands.Context, old: str | None, new: str | None):
        ...
        if len(ctx.message.attachments) >= 2 and (old is None and new is None):
            is_file = True # This will make it return a file at the end, instead of text.
            ...
            try:
                ...
                await ctx.send("I was unable to read these files! Please make sure you upload valid files encoded with UTF-8!")
                return
